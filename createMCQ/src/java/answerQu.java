...
public class answerQu extends HttpServlet {
    @Override
...
"    <div>\n");
        ...
        out.print("<div style='margin-left: 60px;'><form action='postans' method='post'><input type='text' name='ans'/><input style='visibility: hidden' type='text' name='qtable' value='"+q+"'> <input type='submit' value='post answer'/><form/></div>");
        out.print("<hr>");
        Class.forName("com.mysql.jdbc.Driver");
                String url ="jdbc:mysql://localhost:3306/quizup";
                String uname ="root";
                String pass = "root";
                String query = "select answers from "+q;
                ...
                out.print("<ul>");
                out.print("<li style='text-align: center'>"+ans+"</li>");
                out.print("</ul>");
                }
                ...
                String q = request.getParameter("qname");
                out.print("<form action='postans' method='post'><input type='text' name='ans'/><input style='visibility: hidden' type='text' name='qtable' value='"+q+"'> <input type='submit' value='post answer'/><form/>");
                out.print("<h1>"+e+"</h1>");
            }
